      ...
      <div className={styles.inner}>
        <div className={styles.grid}>
          <div className={styles.brand}>
            ...
            <p className={styles.tagline}>Ship AI products that look as smart as they are. The developer productivity platform for modern teams.</p>
            ...
            <div className={styles.newsletter}>
              <form className={styles.newsletterForm} onSubmit={(e) => e.preventDefault()}>
                <input className={styles.newsletterInput} type="email" placeholder="Enter your email" aria-label="Email for newsletter" />
